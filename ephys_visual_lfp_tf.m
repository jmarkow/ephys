function [SPECT_AVE]=ephys_visual_lfp_tf(EPHYS,HISTOGRAM,varargin)
%generates a song-aligned average spectrogram of the LFP
%
%	[LFP_RASTER TIME LABEL HISTOGRAM]=ephys_visual_lfp_tf(EPHYS.data,HISTOGRAM,EPHYS.labels,varargin)
%
%	EPHYS.data
...
save(fullfile(savedir,'lfp_tf_data.mat'),'channels','SPECT_AVE');
