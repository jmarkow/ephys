...
================================
-run_ephys_pipeline_songextract_aggregate.sh (shell script run to temporarily set 
 environment variables and execute the application)
   -to run the shell script, type
   
       ./run_ephys_pipeline_songextract_aggregate.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/R2010a/v716, run the shell script as:
       ...
       ./run_ephys_pipeline_songextract_aggregate.sh /mathworks/home/application/R2010a/v716
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_ephys_pipeline_songextract_aggregate.sh /mathworks/devel/application/matlab
-MCRInstaller.zip 
   -include when building component by clicking "Add MCR" link 
    in deploytool
-The Macintosh bundle directory structure ephys_pipeline_songextract_aggregate.app 
   -this can be gathered up using the zip command 
    zip -r ephys_pipeline_songextract_aggregate.zip ephys_pipeline_songextract_aggregate.app
    or the tar command 
    tar -cvf ephys_pipeline_songextract_aggregate.tar ephys_pipeline_songextract_aggregate.app
-This readme file 
...
A. Mac systems:
   ...
   DYLD_LIBRARY_PATH by issuing the following commands:
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_ephys_pipeline_songextract_aggregate.sh 
