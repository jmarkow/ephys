...
-The Macintosh bundle directory structure ephys_pipeline_sua_track_standalone.app 
   -this can be gathered up using the zip command 
    ...
    or the tar command 
    tar -cvf ephys_pipeline_sua_track_standalone.tar ephys_pipeline_sua_track_standalone.app
-This readme file 
...
A. Mac systems:
   ...
   the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_ephys_pipeline_sua_track_standalone.sh 
